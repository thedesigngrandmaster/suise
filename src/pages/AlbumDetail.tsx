...
export default function AlbumDetail() {
  ...
  return (
    // ... all JSX remains exactly the same as your original file
    // including header, stats, buttons, memories grid, dialogs, owner info, lightbox
    <DashboardLayout activeTab="explore" onTabChange={(tab) => navigate(`/${tab === "home" ? "" : tab}`)}>
      {/* Entire JSX content here, unchanged */}
    </DashboardLayout>
  );
}
