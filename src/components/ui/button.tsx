...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-base font-bold ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-5 [&_svg]:shrink-0 border-2 border-foreground active:translate-y-0.5 active:shadow-neubrutalist-pressed",
  {
    variants: {
      variant: {
        ...
        outline: "bg-background text-foreground shadow-neubrutalist-sm hover:bg-muted",
        ...
        suise: "bg-primary text-primary-foreground shadow-neubrutalist-sm hover:brightness-110 rounded-2xl",
      },
      size: {
